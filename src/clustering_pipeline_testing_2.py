...
LOG_FILE = DATA_PATH + f'logs/candidate_pool_generation_log_2.log'
...
def calculate_expectation(cluster_df, cluster_dict, df, target_ranks_list, system_name):
    ...
    while len(set(all_combinations)) < 2:
        all_combinations.append(tuple(np.random.permutation(cluster_data)))
...
def get_elimination_cluster_cnt(cluster_df, df, sil_score, target_ranks_list=[1], targeted_rank='1'):
    ...
    # ir2_expectation_data_5 = get_cluster_expectation_scores(cluster_df, df, target_ranks_list, system_name='IR5')
    ...
    return {'Query': query,
            ...
            # 'S0 IR1 exp score 5': ir0_expectation_data_0['exp_5'],
            # 'S0 IR1 exp score 10': ir0_expectation_data_0['exp_10'],
            # 'S0 IR1 exp score 15': ir0_expectation_data_0['exp_15'],
            # 'S0 IR1 exp score 20': ir0_expectation_data_0['exp_20'],
            # 'S0 IR1 exp score 25': ir0_expectation_data_0['exp_25'],
            # 'S0 IR1 exp score avg': ir0_expectation_data_0['exp_avg'],
            # 'S0 IR1 exp score ap': ir0_expectation_data_0['ap_ir0'],
            ...
            # 'S2 IR1 exp score avg': ir2_expectation_data_2['exp_avg'],
            ...
            # 'S3 IR1 exp score avg': ir2_expectation_data_3['exp_avg'],
            ...
            # 'S4 IR1 exp score avg': ir2_expectation_data_4['exp_avg'],
            ...
            # 'S5 IR1 exp score avg': ir2_expectation_data_5['exp_avg'],
            }
...
def write_clusteroutput_data(clustering_output, hyperparameters_set, cdd_type, targeted_rank):
    ...
    #     clustering_output_df.to_excel(clustering_df_folderpath + f'{clustering_type}_clustering_output_df_cdd_{targeted_rank}.xlsx', engine='xlsxwriter', index=False)
    # elif cdd_type == 'small_cdd':
    #     clustering_output_df.to_excel(clustering_df_folderpath + f'{clustering_type}_clustering_output_df_{targeted_rank}.xlsx', engine='xlsxwriter', index=False)
